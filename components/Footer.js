                            ...
                            <div className="row">
                                <div className="col-lg-6 mx-auto text-center">
                                    <div className="section-heading footer-heading">
                                        ...
                                        <h2 className="section__title text__white">Sign up for our latest updates</h2>
                            ...
                            <div className="row footer-widget-wrap">
                                ...
                                <div className="col footer-item footer-item2">
                                    ...
                                    <ul className="foot__links">
                                        ...
                                        <li><a href="#">Related Blog Posts</a></li>
                                    </ul>
                                </div>
                                ...
                                <div className="col footer-item footer-item4">
                                    ...
                                    <ul className="contact__info">
                                        <li><a href="mailto:needhelp@oxpitan.com">tobedecided@gmail.com</a></li>
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="copyright-desc">
                                        <p>© Copyright 2024 by <a href="#">Inspirecare.ca</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
